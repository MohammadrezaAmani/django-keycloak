...
class BackendsKeycloakAuthorizationBaseHasPermTestCase(MockTestCaseMixin, TestCase):
    def setUp(self):
        ...
        self.setup_mock(
            ...
            return_value={
                "authorization": {
                    "permissions": [
                        {"resource_set_name": "Resource", "scopes": ["Read", "Update"]},
    ...
    def test_resource_no_scope_should_not_have_permission(self):
        ...
        """
        permission = self.backend.has_perm(user_obj=self.profile.user, perm="Resource")
    ...
    def test_resource_no_scope_should_have_permission(self):
        ...
        Expected: Permission granted.
        """
        permission = self.backend.has_perm(user_obj=self.profile.user, perm="Resource2")
