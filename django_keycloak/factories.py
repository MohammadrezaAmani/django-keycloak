...
from django_keycloak.models import Client, OpenIdConnectProfile, Realm, Server
...
class RealmFactory(factory.DjangoModelFactory):
    ...
    client = factory.RelatedFactory("django_keycloak.factories.ClientFactory", "realm")
...
class ClientFactory(factory.DjangoModelFactory):
    ...
    service_account_profile = factory.SubFactory(
        OpenIdConnectProfileFactory, realm=factory.SelfAttribute("..realm")
    )
