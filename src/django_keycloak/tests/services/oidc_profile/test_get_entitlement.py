...
class ServicesKeycloakOpenIDProfileGetActiveAccessTokenTestCase(
    ...
    def setUp(self):
        self.mocked_get_active_access_token = self.setup_mock(
            "django_keycloak.services.oidc_profile" ".get_active_access_token"
        )
        ...
        self.oidc_profile.realm.client.authz_api_client.entitlement.return_value = {
            "rpt": "RPT_VALUE"
        }
    ...
    def test(self):
        ...
        self.oidc_profile.realm.client.authz_api_client.entitlement.assert_called_once_with(
            token=self.mocked_get_active_access_token.return_value
        )
        self.oidc_profile.realm.client.openid_api_client.decode_token.assert_called_once_with(
            token="RPT_VALUE",
